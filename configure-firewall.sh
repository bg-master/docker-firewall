...
FIREWALL_CHAIN=${F2B_LOG_TARGET:-DOCKER-FIREWALL}
FIREWALL_OPEN_TCP_PORTS=${FIREWALL_OPEN_TCP_PORTS:-22}
FIREWALL_OPEN_UDP_PORTS=${FIREWALL_OPEN_UDP_PORTS}
FIREWALL_ACCEPT_ALL_FROM=${FIREWALL_ACCEPT_ALL_FROM}
